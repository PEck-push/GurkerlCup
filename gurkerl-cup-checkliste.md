...
> Alles Spiel-Relevante auf einen Blick. Einkaufsmengen siehe `gurkerl-cup-einkaufsliste.csv` (geplant für **bis zu 16 Teams**).
...
- [ ] Migration ist eingespielt ✅ (bereits erledigt: `gc_config/gc_teams/gc_scores` + Timer-Spalten)
- [ ] **Punkte-Raster prüfen** im Admin (ist bereits Regelwerk-konform: 12·10·8·7·6·5·4·3·2·1 · Ringerl 20·15·12·8·8·8 · Bälle 40·30·24·16·16·16)
...
- [ ] **Eröffnung – Mutter Stapeln:** Bänke + je Team 1 Stab & 6 Muttern bereitlegen
- [ ] **Station 1 – Simon:** Gerät + Batterien testen
- [ ] **Station 2 – Cornhole:** 3 Boards bei 3 / 5 / 7 m, Zonen markieren, 8 Säckchen
...
- [ ] **Station 7 – Gurkerlglasl:** Gläser als Pyramide, TT-Bälle (5/Person)
- [ ] **Phase B – Riesen-Ringerl:** Netz + Ball + Feldlinien
...
- [ ] **15:15** OPENING **Mutter Stapeln** – alle gleichzeitig · **Timer** im Admin scharfschalten → START, Teams stoppen selbst
...
- [ ] **20:00** Phase B **Riesen-Ringerl** – Ausgeschiedene live antippen
