...
const steps: Step[] = [
  ...
  },
  {
    ...
    body: 'Sieben Stationen, frei wählbare Reihenfolge – während das Fest parallel läuft. Wann ihr antritt, in welcher Reihenfolge ihr vorgeht und wann ihr die Gurkerl-Karte zieht: alles euer Spiel.',
    accent: '#52B788',
  ...
  },
  {
    ...
    body: 'Nach der Zeremonie wird es ernst: zwei Disziplinen, alle Teams gleichzeitig, kein Entrinnen. Wer hier liefert, trägt die Goldene Gurke nach Hause. Wer zögert, schaut zu.',
    accent: '#FB923C',
