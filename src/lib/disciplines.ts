...
export const disciplines: Discipline[] = [
  ...
  },
  {
    ...
    teaser:
      'Ihr werdet Songs hören, die ihr kennt. Nur klingen sie gerade… etwas seltsam. Jeder von euch bekommt 90 Sekunden, um möglichst viele richtige Antworten zu liefern.',
    time: '3× 1:30 Min. (fix)',
...
export type InputMode = 'number' | 'time' | 'elimination' | 'manual-place';
...
export const SCORING_META: Record<string, DisciplineMeta> = {
  ...
  kazoomeister: { direction: 'desc', pointsGroup: 'phase_a', gamePhase: 'a', cardsAllowed: true, inputUnit: 'Songs', inputMode: 'number', perPlayer: true },
  ...
  'riesen-ringerl': { direction: 'asc', pointsGroup: 'riesen-ringerl', gamePhase: 'b', cardsAllowed: false, inputUnit: 'Platz', inputMode: 'elimination', roundsAveraged: 3 },
