...
import OpeningReveal from '@/components/tournament/OpeningReveal';
...
function Inner() {
  ...
  if (s === 'opening') {
    // Live-Platzierung: nur ein Teil der Teams schon von der Turnierleitung eingetragen.
    const scores: GcScore[] = teams.slice(0, 9).map((t, i) => ({ id: `o${i}`, team_id: t.id, discipline_id: 'mutter-stapeln', raw_value: null, p1: null, p2: null, p3: null, finished: true, card_double: false, card_second: false, manual_rank: i + 1, updated_at: '' }));
